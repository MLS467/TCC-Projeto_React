...
import { DashboardAdmContext } from "./context.js";
...
const DashboardAdmInsertProvider = ({ children }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        throw Error("Não foi possível inserir administrador");
      }
    } catch (error) {
...
export default DashboardAdmInsertProvider;
