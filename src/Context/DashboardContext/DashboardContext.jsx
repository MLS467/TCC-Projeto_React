...
export const DashboardProvider = ({ children }) => {
  ...
  const updateTitle = () => {
    let type;
    if (tipo === "doctor") type = "Médicos";
    else if (tipo === "attendant") type = "Atendentes";
    else if (tipo === "nurse") type = "Enfermeiros";
    else if (tipo === "consultation") type = "Consultas";
    return type;
  };

  return (
    <DashboardContext.Provider
      value={{ updateTitle, requestDelete, data, requestControle, tipo }}
    >
      {children}
    </DashboardContext.Provider>
  );
