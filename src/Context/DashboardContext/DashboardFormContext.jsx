  ...
  const requestAdd = async (event) => {
    ...
    const schema = Yup.object().shape({
      ...
      age: Yup.number()
        ...
        .min(18, "A idade deve ser maior que 18")
      ...
      place_of_birth: Yup.string()
        ...
        .max(100, "O local de nascimento deve ter no máximo 100 caracteres"),
      city: Yup.string()
      ...
      block: Yup.string()
        .nullable()
        .max(10, "O bloco deve ter no máximo 10 caracteres"),
      apartment: Yup.string()
        .nullable()
        .max(10, "O apartamento deve ter no máximo 10 caracteres"),
      crm: Yup.string()
        .nullable()
        .matches(/^CRM\d+$/, "O CRM deve começar com 'CRM' seguido de números")
        .notRequired(),
      ...
      coren: Yup.string()
        .nullable()
        .matches(/^\d{8}$/, "O COREN deve conter exatamente 8 dígitos")
        .notRequired(),
