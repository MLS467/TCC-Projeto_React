            ...
            <FormGlobal>
                ...
                <form onSubmit={requestAdd}>
                    ...
                    <FormSectionGlobal legends="Informações pessoais">
                        ...
                        <FormRowGlobal>
                            <InputLogin handleChange={handleChange} placeholder="E-mail" name="email" type="email" />
                            <InputLogin handleChange={handleChange} placeholder="Telefone" name="phone" type="text" />
                        </FormRowGlobal>

                        <FormRowGlobal>
                            <InputLogin handleChange={handleChange} placeholder="CPF" name="cpf" type="text" />
                            <InputLogin handleChange={handleChange} placeholder="Sexo" name="sex" type="text" />
                        </FormRowGlobal>

                        <FormRowGlobal>
                            <InputLogin handleChange={handleChange} placeholder="Data de nascimento" name="birth" type="date" />
                            <InputLogin handleChange={handleChange} placeholder="Local de nascimento" name="place_of_birth" type="text" />
                        </FormRowGlobal>
                        ...
                        <FormRowGlobal>
                            <InputLogin handleChange={handleChange} placeholder="Rua" name="street" type="text" />
                            <InputLogin handleChange={handleChange} placeholder="Bloco" name="block" type="text" />
                        </FormRowGlobal>

                        <FormRowGlobal>
                            <InputLogin handleChange={handleChange} placeholder="Apartamento" name="apartment" type="text" />
                        </FormRowGlobal>
                    </FormSectionGlobal>
                    ...
                    {form.role === 'doctor' && (
                        <FormSectionGlobal legends="Informações de Doutor">
                            <FormRowGlobal>
                                <InputLogin handleChange={handleChange} placeholder="CRM" name="crm" type="text" />
                                <InputLogin handleChange={handleChange} placeholder="Especialidade" name="specialty" type="text" />
                            </FormRowGlobal>
                    ...
                    {form.role === 'nurse' && (
                        <FormSectionGlobal legends="Informações de Enfermeira">
                            <FormRowGlobal>
                                <InputLogin handleChange={handleChange} placeholder="COREN" name="coren" type="text" />
                                <InputLogin handleChange={handleChange} placeholder="Especialidade" name="speciality" type="text" />
                                <CheckBoxGlobal name="active" text="Ativo" handleChange={handleChange} placeholder="Ativo" type="checkbox" />
                            </FormRowGlobal>
                        </FormSectionGlobal>
                    )}
                    ...
                    <ContainerBtnStyle>
                        <BtnGlobal text="Adicionar" size="l" type="submit">Adicionar</BtnGlobal>
                    </ContainerBtnStyle>
                </form>
            </FormGlobal>
