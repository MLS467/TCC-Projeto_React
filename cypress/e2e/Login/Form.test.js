...
describe("Data flow test", () => {
  ...
  it("path to the form and to add data fields", () => {
    ...
    mock.data.forEach((data) => {
      ...
      data.place_of_birth
        ? cy.get("input[name=place_of_birth]").type(data.place_of_birth)
        : null;
